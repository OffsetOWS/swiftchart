...
3. In Supabase Auth providers, enable Google OAuth.
4. Add these redirect URLs in Supabase Auth URL configuration:
   - `https://swiftchart.vercel.app/app`
   - `http://localhost:5173/app`
5. Add these frontend environment variables in Vercel:
   - `VITE_SUPABASE_URL`
