...
class Settings(BaseSettings):
    ...
    hyperliquid_candle_fetch_backoff_seconds: float = Field(default=0.4, ge=0)
    hyperliquid_candle_request_delay_seconds: float = Field(default=0.12, ge=0)
    hyperliquid_candle_concurrency: int = Field(default=4, ge=1, le=20)
